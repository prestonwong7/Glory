...
puppet var rotation_helper_basis
...
remote func data_receive(received_data):
	data = {
		"speed" : received_data["speed"],
		"velocity" : received_data["velocity"],
		"position" : received_data["position"]
	}
	speed = received_data["speed"]
	velocity = received_data["velocity"]
	print("speed: ", received_data["speed"])
	print("velocity: ", received_data["velocity"])
	print("position: ", received_data["position"])
	
remote func update_rotation(rotation_received_data):
	x_delta = rotation_received_data["x_delta"]
	rotate_y = rotation_received_data["rotate_y"]
	move_rotation = rotation_received_data["move_rotation"]
